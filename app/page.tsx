...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#0F2A1E] text-[#F3EEDD] pb-24 pt-24" style={{ fontFamily: "'Work Sans', sans-serif" }}>
      <style jsx global>{`
  ...
  <div className="max-w-6xl mx-auto flex items-center justify-between">
    <div className="flex items-center gap-3 w-full">
      ...
      <div className="flex flex-col w-full">
        {/* Top row: AVP Agency and Language text side by side */}
        <div className="flex items-center justify-between">
          <p className="font-display text-lg sm:text-xl leading-tight text-[#F3EEDD] font-bold">AVP Agency</p>
          <span className="text-[10px] sm:text-xs text-[#C9BE9C] font-medium shrink-0">
            ENG · മലയാളം · தமிழ்
          </span>
        </div>
        {/* Bottom row: Full length company name */}
        <p className="text-[9px] sm:text-[10px] tracking-wide text-[#C9BE9C] uppercase font-semibold mt-0.5">THE ARYA VAIDYA PHARMACY (COIMBATORE) LIMITED</p>
      </div>
    </div>
  </div>
</header>
      ...
      <section className="max-w-6xl mx-auto px-3 sm:px-6 py-3">
        <div className="bg-gradient-to-r from-amber-500 to-amber-600 border border-amber-400/50 rounded-xl p-4 sm:p-5 text-emerald-950 text-center shadow-md relative overflow-hidden">
          ...
          <p className="text-xs sm:text-sm font-medium mb-2.5 text-emerald-950/90">Connect directly with our Senior Ayurveda Physician via WhatsApp for correct dosage.</p>
          <a
            href={docWaLink}
            target="_blank"
