...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#0F2A1E] text-[#F3EEDD] pb-24 pt-24" style={{ fontFamily: "'Work Sans', sans-serif" }}>
      ...
      {/* Doctor consultation banner with stethoscopes and WhatsApp icon */}
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 mb-6 text-xs sm:text-sm">
          <div>
            ...
            <p className="text-[#A9BAAC] leading-relaxed">
              Authorized online dispensary for authentic AVP formulations. Dedicated to delivering genuine wellness solutions.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-[#A9BAAC] leading-relaxed mb-2">
              Reach out to our team for guidance on product selection and personal assistance.
            </p>
