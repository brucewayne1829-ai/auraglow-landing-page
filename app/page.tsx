...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#0F2A1E] text-[#F3EEDD] pb-24 pt-16 sm:pt-20" style={{ fontFamily: "'Work Sans', sans-serif" }}>
      ...
      {/* Header */}
      <header className="fixed top-0 left-0 right-0 bg-[#0F2A1E]/95 backdrop-blur border-b border-[#B8862F]/30 py-2.5 px-2.5 sm:px-6 z-50 shadow-lg">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-2.5 w-full">
            <div className="bg-[#F3EEDD] p-1 rounded-lg shrink-0">
              <img
      ...
      <section className="max-w-6xl mx-auto px-3 sm:px-6 py-2">
        <div className="bg-gradient-to-r from-amber-500 to-amber-600 border border-amber-400/50 rounded-xl p-3 sm:p-4 text-emerald-950 text-center shadow-md relative overflow-hidden">
          ...
          <p className="text-xs sm:text-sm font-bold mb-2 text-emerald-950">
            Connect directly with our Senior Ayurveda Physician via WhatsApp for correct dosage.
          </p>
  <a
  href={docWaLink}
  target="_blank"
      ...
      <section id="medicines" className="max-w-6xl mx-auto px-3 sm:px-6 py-3">
        <div className="flex flex-col gap-3 mb-4">
          <div className="flex items-center justify-between">
            <h2 className="font-display text-base sm:text-lg text-[#B8862F] font-semibold tracking-wide">
              Medicine List
            </h2>
          ...
          <div className="relative w-full">
            ...
            <input
              ...
              className="w-full bg-[#123626] border border-[#B8862F]/50 focus:border-[#B8862F] rounded-xl pl-10 pr-4 py-2.5 text-sm text-[#F3EEDD] placeholder-[#8FA192] shadow-inner focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#B8862F]/50"
            />
          </div>
        </div>
          ...
          {categories.map((cat, index) => {
            ...
            return (
              <button
                ...
                className={`text-sm pb-1 border-b-2 motion-safe:transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#B8862F] rounded-sm ${
                  isActive
                    ? "border-[#B8862F] text-[#F3EEDD] font-bold"
        ...
        {filteredProducts.length > 0 ? (
                ...
                <li key={item.id} className="relative">
                  ...
                  <div className="bg-[#123626] border border-t-0 border-[#B8862F]/30 rounded-b-lg p-5">
                    <div className="flex items-center justify-between mb-1.5">
                      <p className="text-xs tracking-wide text-[#B8862F] font-semibold">{item.category}</p>
                    ...
                    <p className="text-base text-[#D9D0B4] mb-5 leading-relaxed">{item.desc}</p>
                    
                    <div className="grid grid-cols-2 gap-2">
                      <button
                        onClick={() => handleQuickBuy(item)}
                        className="w-full bg-[#B8862F] text-[#0F2A1E] font-bold py-2.5 px-2 rounded-full hover:bg-[#CB9B3F] motion-safe:transition-colors text-sm sm:text-base focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#F3EEDD] text-center truncate"
                      >
                        Quick Buy
                      </button>
                      <button
                        ...
                        className={`w-full py-2.5 px-2 rounded-full border motion-safe:transition-colors text-sm sm:text-base font-bold focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#B8862F] text-center truncate ${
                          isSelected
          ...
          <div className="border border-[#B8862F]/30 rounded-2xl p-10 text-center">
            <p className="text-[#D9D0B4] text-base mb-6">Nothing matched that search — ask us directly instead.</p>
            <a
              href={`https://wa.me/${whatsappNumber}?text=${encodeURIComponent('Hi, I want to inquire about products.')}`}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-[#B8862F] text-[#0F2A1E] font-bold text-sm sm:text-base py-3 px-7 rounded-full hover:bg-[#CB9B3F] motion-safe:transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#F3EEDD]"
            >
              Ask on WhatsApp
            </a>
          </div>
      ...
      <section className="max-w-6xl mx-auto px-3 sm:px-6 py-6 grid md:grid-cols-2 gap-6">
        <div>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-1.5 text-[#B8862F] font-semibold border-b border-[#B8862F]/40 hover:border-[#B8862F] pb-0.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#B8862F] rounded-sm text-xs sm:text-sm"
          >
            Open in Google Maps
          </a>
        </div>
        <div className="bg-[#123626] border border-[#B8862F]/30 rounded-xl p-5 flex flex-col justify-center">
          <p className="font-display text-lg text-[#F3EEDD] mb-1.5">Delivery, pan-India</p>
          <p className="text-[#F3EEDD] leading-relaxed text-sm sm:text-base mb-2">
            Direct delivery across India via secure prepaid WhatsApp orders.
          </p>
          <p className="text-[#B8862F] text-sm sm:text-base font-bold">
      ...
      <footer className="border-t border-[#B8862F]/30 bg-[#0A2217] pt-8 pb-6 px-4 text-[#D9D0B4]">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 mb-6 text-xs sm:text-sm">
          ...
          <div>
            ...
            <p className="text-[#A9BAAC] leading-relaxed mb-3 text-xs sm:text-sm">
            ...
            <div className="inline-block bg-[#123626] border border-[#B8862F]/40 px-3 py-1.5 rounded-lg text-xs sm:text-sm text-[#C9BE9C] font-semibold">
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-[#0F2A1E]/95 backdrop-blur border-t border-[#B8862F]/40 py-2.5 px-3 sm:px-6 z-50">
          <div className="max-w-6xl mx-auto flex items-center justify-between gap-3">
            <p className="text-[#D9D0B4] text-xs sm:text-sm">
              <span className="text-[#F3EEDD] font-bold">{cart.length}</span> item{cart.length > 1 ? "s" : ""} ready to send
            </p>
            <button
              onClick={handleCartCheckout}
              className="bg-[#B8862F] text-[#0F2A1E] font-bold py-2 px-5 rounded-lg hover:bg-[#CB9B3F] motion-safe:transition-colors text-xs sm:text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#F3EEDD]"
            >
