      ...
      <main className="max-w-4xl mx-auto py-6 px-4 w-full">
        ...
        {filteredProducts.length > 0 ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 justify-center mb-8">
            {filteredProducts.map((item) => {
              ...
              return (
                <div key={item.id} className="bg-emerald-900 border border-emerald-700/30 rounded-2xl overflow-hidden flex flex-col justify-between shadow-lg">
                  <div>
                    {/* Cream background for image with reduced height */}
                    ...
                    <div className="p-4">
                      ...
                      <p className="font-display text-base text-amber-300 mb-1 font-bold">{item.price}</p>
                    </div>
                  </div>
          ...
          <div className="bg-emerald-900/40 backdrop-blur-md border border-emerald-700/40 rounded-2xl p-6 text-center text-white mb-8 shadow-xl">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block bg-amber-400 hover:bg-amber-500 text-emerald-950 font-black py-2 px-4 rounded-xl text-xs transition-all shadow"
            >
        ...
        <section className="bg-emerald-900/40 backdrop-blur-xl border border-emerald-700/40 rounded-2xl p-5 text-white text-center shadow-xl">
          ...
          <div className="text-[11px] sm:text-xs text-emerald-100/90 leading-relaxed max-w-lg mx-auto mb-4 space-y-0.5">
            ...
            <p className="pt-2 text-[11px] text-amber-300 font-bold tracking-wide">📦 Pan-India Secure Courier Delivery Available</p>
          </div>
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-emerald-950/95 backdrop-blur-2xl border-t border-emerald-700/50 shadow-2xl p-3 px-4 z-50">
          <div className="max-w-4xl mx-auto flex items-center justify-between">
            <div className="text-white">
              ...
              <p className="text-[9px] text-emerald-200/80">Ready for instant WhatsApp checkout</p>
            </div>
            <button
              onClick={handleCartCheckout}
              className="bg-amber-400 hover:bg-amber-500 text-emerald-950 text-xs font-black px-4 py-2.5 rounded-xl shadow-lg transition-all ring-1 ring-amber-300/50"
            >
